...
const translations = {
  zh: {
    ...
    'create.placeholderTitle': '请输入帖子标题（1-200个字符）',
    'create.placeholderContent': '请输入帖子内容（可选）',
    ...
    'tasks.checkin': '每日签到',
    'tasks.doCheckin': '签到',
    'tasks.completing': '处理中...',
    'tasks.done': '已完成',
    'tasks.error': '完成任务失败，请稍后重试',
    'tasks.completed': '已完成',
    'tasks.exp': '经验',
    ...
    'image.label': '文件（可选）',
    'image.alertSelect': '请选择文件',
    'image.alertMax': '最多只能上传 {max} 个文件',
    'image.alertSize': '文件大小不能超过 30MB',
    'image.processFail': '处理文件失败，请重试',
    'image.uploadFail': '文件 {name} 上传失败: {message}',
    'image.uploading': '上传中...',
    'image.cta': '点击或拖拽文件到这里上传',
    'image.hint': '支持所有文件类型，单文件不超过 30MB，最多 {max} 个',
  ...
  en: {
    ...
    'auth.codeSent': 'Verification code sent to your email, valid for 5 minutes',
    'auth.retryAfter': '{countdown}s to retry',
    ...
    'create.placeholderTitle': 'Enter a title (1-200 characters)',
    'create.placeholderContent': 'Enter post content (optional)',
    ...
    'tasks.checkin': 'Daily check-in',
    'tasks.doCheckin': 'Check-in',
    'tasks.completing': 'Working...',
    'tasks.done': 'Done',
    'tasks.error': 'Failed to complete task, please retry',
    ...
    'image.label': 'Files (optional)',
    'image.alertSelect': 'Please choose files.',
    'image.alertMax': 'You can upload up to {max} files.',
    'image.alertSize': 'Each file must be smaller than 30 MB.',
    'image.processFail': 'Failed to process files. Please try again.',
    'image.uploadFail': 'Failed to upload {name}: {message}',
    'image.uploading': 'Uploading...',
    'image.cta': 'Click or drag files here to upload',
    'image.hint': 'Supports all file types. Max 30 MB per file, up to {max} files.',
  ...
  ja: {
    ...
    'auth.username': 'ユーザー名 *',
    'auth.usernamePlaceholder': '3-20文字、半角英数字とアンダースコアのみ',
    'auth.email': 'メールアドレス *',
    'auth.emailPlaceholder': 'your@email.com',
    ...
    'auth.codeSent': '認証コードがメールに送信されました。有効期限は5分です。',
    ...
    'create.placeholderTitle': '1〜200文字でタイトルを入力してください',
    'create.placeholderContent': '本文を入力してください（任意）',
    ...
    'tasks.like': 'いいね',
    'tasks.comment': 'コメント',
    'tasks.checkin': 'デイリーチェックイン',
    'tasks.doCheckin': 'チェックイン',
    'tasks.completing': '処理中...',
    'tasks.done': '完了',
    'tasks.error': 'タスク完了に失敗しました。後で再試行してください',
    'tasks.completed': '完了',
    'tasks.exp': '経験値',
    ...
    'image.label': 'ファイル（任意）',
    'image.alertSelect': 'ファイルを選択してください。',
    'image.alertMax': 'アップロードできるのは最大 {max} 個までです。',
    'image.alertSize': '各ファイルのサイズは 30MB 未満である必要があります。',
    'image.processFail': 'ファイルの処理に失敗しました。もう一度お試しください。',
    'image.uploadFail': '{name} のアップロードに失敗しました: {message}',
    'image.uploading': 'アップロード中...',
    'image.cta': 'クリックまたはドラッグ＆ドロップでファイルを追加',
    'image.hint': 'すべてのファイルタイプに対応、1つ 30MB 以内、最大 {max} 個まで',
